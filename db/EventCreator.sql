...
INSERT INTO USERS VALUES (default, "45523007846", "David Tolentino", "19981413209", "DanGling", "98", "bela Rosa 2", "Rio paris", "Artur Nogueira", "SP", "terno.jpeg", default),
...
(default, (select concat(logradouro, ", ", cidade, "-", estado) from users where id_users = 1), "FUTEBOL", "-27.134741", "-48.899448", date_add(curdate(), interval 0 week), date_add(date_add(curdate(), interval 0 week), interval 0 day), "10:20:00", true, 1, null, 4),
(default, (select concat(logradouro, ", ", cidade, "-", estado) from users where id_users = 1), "LUTA", "-27.134741", "-48.899448", date_add(curdate(), interval 0 week), date_add(date_add(curdate(), interval 0 week), interval 0 day), "10:20:00", true, 1, null, 8);
...
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  10), 10, 9, true, "LUTA", 1, (select uri from users where id_users =  10), default);
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  12), 12, 9, true, "LUTA", 2, (select uri from users where id_users =  12), default);
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  17), 17, 9, true, "LUTA", 3, (select uri from users where id_users =  17), default);
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  4), 4, 9, true, "LUTA", 4, (select uri from users where id_users =  4), default);
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  6), 6, 9, true, "LUTA", 5, (select uri from users where id_users =  6), default);
INSERT INTO TEAM VALUES(default, (select nome from users where id_users =  20), 20, 9, true, "LUTA", 6, (select uri from users where id_users =  20), default);
